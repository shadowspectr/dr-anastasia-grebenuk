...
export const YandexMetrika = () => {
  useEffect(() => {
    ...
    script.innerHTML = `
      ...
      ym(99535835, 'init', {webvisor:true, clickmap:true, accurateTrackBounce:true, trackLinks:true});
    `;
    ...
    noscript.innerHTML = '<div><img src="https://mc.yandex.ru/watch/99535835" style="position:absolute; left:-9999px;" alt="" /></div>';
