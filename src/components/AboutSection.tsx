        ...
        <div className="bg-card rounded-3xl p-6 shadow-sm border border-border hover:shadow-lg transition-all duration-300 hover:scale-[1.02]">
          ...
          <div className="mt-8">
            ...
            <div className="space-y-3">
              {(mainContent?.about_advantages || ["высококвалифицированные специалисты с медицинским образованием", "большой спектр различных услуг", "удобное расположение в самом центре Ростова-на-Дону", "высокий уровень сервиса", "безупречная репутация", "полное доверие более 10.000 пациентов"]).map((advantage: string, index: number) => <div key={index} className="flex items-start gap-3 animate-slide-in-right" style={{
